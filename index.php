...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      <h2>Tafuta Nguo Nzuri <span>kwa ajili yako</span></h2>
      <p>Hapa kutana na nguo nzuri kutoka kwa mafundi waliobobea na wanaojulikana ndani na njee ya nchi kwa ubora wa kazi zao walizozifanya zenye viwango vya hali ya juu kimataifa. </p>
    </div>
    <div class="row"> 
      ...
      <div class="recent-tab">
        <ul class="nav nav-tabs" role="tablist">
          <li role="presentation" class="active"><a href="#resentnewcar" role="tab" data-toggle="tab">Staili Mpya</a></li>
        </ul>
      </div>
...
<ul>
<li><i  aria-hidden="true"></i><?php echo htmlentities($result);?></li>
<li><i  aria-hidden="true"></i><?php echo htmlentities($result);?> </li>
<li><i  aria-hidden="true"></i><?php echo htmlentities($result);?> </li>
</ul>
</div>
...
<span class="price">Tsh <?php echo htmlentities($result->PricePerDay);?> </span> 
</div>
